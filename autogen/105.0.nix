{
  ...
  "6000" = {
    ...
    "6050" = {
      settings = [
        { name = "browser.urlbar.trimURLs"; enabled = false; value = ""; }
        { name = "dom.caches.enabled"; enabled = false; value = ""; }
        { name = "dom.storageManager.enabled"; enabled = false; value = ""; }
        { name = "dom.storage_access.enabled"; enabled = false; value = ""; }
        { name = "dom.targetBlankNoOpener.enabled"; enabled = false; value = ""; }
        { name = "network.cookie.thirdparty.sessionOnly"; enabled = false; value = ""; }
        { name = "network.cookie.thirdparty.nonsecureSessionOnly"; enabled = false; value = ""; }
        { name = "privacy.firstparty.isolate.block_post_message"; enabled = false; value = ""; }
        { name = "privacy.firstparty.isolate.restrict_opener_access"; enabled = false; value = ""; }
        { name = "privacy.firstparty.isolate.use_site"; enabled = false; value = ""; }
        { name = "privacy.window.name.update.enabled"; enabled = false; value = ""; }
        { name = "security.insecure_connection_text.enabled"; enabled = false; value = ""; }
      ];
      meta = {
  ...
  "9000" = {
    "9000" = {
      settings = [
        ...
        { name = "browser.warnOnQuitShortcut"; enabled = false; value = false; }
        { name = "full-screen-api.warning.delay"; enabled = false; value = 0; }
        { name = "full-screen-api.warning.timeout"; enabled = false; value = 0; }
        { name = "app.update.auto"; enabled = false; value = false; }
        { name = "browser.search.update"; enabled = false; value = false; }
        ...
        { name = "browser.newtabpage.activity-stream.feeds.section.topstories"; enabled = false; value = false; }
        { name = "browser.newtabpage.activity-stream.section.highlights.includePocket"; enabled = false; value = false; }
        { name = "media.autoplay.default"; enabled = false; value = 5; }
        { name = "media.autoplay.blocking_policy"; enabled = false; value = 2; }
        ...
        { name = "browser.sessionstore.interval"; enabled = false; value = 30000; }
