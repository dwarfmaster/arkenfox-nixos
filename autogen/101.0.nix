{
  ...
  "2800" = {
    "2801" = {
      settings = [
        { name = "network.cookie.lifetimePolicy"; enabled = true; value = 2; }
      ];
      meta = {
        title = "delete cookies and site data on exit";
        description = ''
    ...
    "2802" = {
      ...
      meta = {
        title = "delete cache on exit [FF96+]";
        description = ''
          '';
    ...
    "2810" = {
      ...
      meta = {
        title = "enable Firefox to clear items on shutdown (2811)";
        description = ''
          '';
    ...
    "2811" = {
      settings = [
        ...
        { name = "privacy.clearOnShutdown.offlineApps"; enabled = true; value = false; }
        { name = "privacy.clearOnShutdown.cookies"; enabled = true; value = false; }
    ...
    "2812" = {
      ...
      meta = {
        title = "reset default items to clear with Ctrl-Shift-Del (to match 2811) [SETUP-CHROME]";
        description = ''
    ...
    "2814" = {
      ...
      meta = {
        title = "reset default \"Time range to clear\" for \"Clear Recent History\" (2812)";
        description = ''
  ...
  "6000" = {
    ...
    "6007" = {
      ...
      meta = {
        title = "enforce Local Storage Next Generation (LSNG) [FF65+]";
        description = ''
          '';
        links = {
        };
    ...
    "6012" = {
      ...
      meta = {
        title = "disable SHA-1 certificates";
        description = ''
          '';
        links = {
        };
