{
  ...
  "0100" = {
    ...
    "0105" = {
      ...
      meta = {
        title = "disable sponsored content on Firefox Home (Activity Stream)";
        description = ''
          '';
  ...
  "0200" = {
    ...
    "0202" = {
      settings = [
        ...
        { name = "geo.provider.use_geoclue"; enabled = true; value = false; }
      ];
      meta = {
  ...
  "0300" = {
    ...
    "0335" = {
      ...
      meta = {
        title = "disable Firefox Home (Activity Stream) telemetry";
        description = ''
          '';
        links = {
        };
  ...
  "0400" = {
    ...
    "0403" = {
      settings = [
        ...
        { name = "browser.safebrowsing.downloads.remote.url"; enabled = false; value = ""; }
      ];
      meta = {
  ...
  "0600" = {
    ...
    "0603" = {
      settings = [
        ...
        { name = "network.predictor.enable-prefetch"; enabled = true; value = false; }
      ];
      meta = {
    ...
    "0605" = {
      settings = [
        { name = "browser.places.speculativeConnect.enabled"; enabled = true; value = false; }
      ];
      meta = {
  ...
  "0700" = {
    ...
    "0705" = {
      settings = [
        { name = "network.proxy.failover_direct"; enabled = false; value = false; }
      ];
      meta = {
    ...
    "0706" = {
      settings = [
        { name = "network.proxy.allow_bypass"; enabled = false; value = false; }
      ];
      meta = {
  ...
  "0800" = {
    ...
    "0807" = {
      settings = [
        { name = "browser.urlbar.suggest.quicksuggest.nonsponsored"; enabled = true; value = false; }
        { name = "browser.urlbar.suggest.quicksuggest.sponsored"; enabled = true; value = false; }
      ];
      meta = {
  ...
  "0900" = {
    ...
    "0906" = {
      settings = [
        { name = "network.http.windows-sso.enabled"; enabled = false; value = false; }
      ];
      meta = {
  ...
  "1200" = {
    ...
    "1212" = {
      ...
      meta = {
        title = "set OCSP fetch failures (non-stapled, see 1211) to hard-fail";
        description = ''
    ...
    "1241" = {
      settings = [
        { name = "security.mixed_content.block_display_content"; enabled = false; value = true; }
      ];
      meta = {
        title = "disable insecure passive content (such as images) on https pages";
        description = ''
          '';
        links = {
        };
  ...
  "1400" = {
    "1402" = {
      settings = [
        { name = "layout.css.font-visibility.private"; enabled = false; value = 1; }
        { name = "layout.css.font-visibility.standard"; enabled = false; value = 1; }
        { name = "layout.css.font-visibility.trackingprotection"; enabled = false; value = 1; }
      ];
      meta = {
  ...
  "2000" = {
    ...
    "2004" = {
      settings = [
        { name = "media.peerconnection.ice.no_host"; enabled = false; value = true; }
      ];
      meta = {
    ...
    "2022" = {
      settings = [
        ...
        { name = "browser.eme.ui.enabled"; enabled = false; value = false; }
      ];
      meta = {
  ...
  "2600" = {
    ...
    "2606" = {
      settings = [
        ...
        { name = "browser.uitour.url"; enabled = false; value = ""; }
      ];
      meta = {
    ...
    "2620" = {
      ...
      meta = {
        title = "enforce PDFJS, disable PDFJS scripting";
        description = ''
    ...
    "2624" = {
      settings = [
        { name = "browser.tabs.searchclipboardfor.middleclick"; enabled = true; value = false; }
      ];
      meta = {
        title = "disable middle click on new tab button opening URLs or searches using clipboard [FF115+] */";
        description = ''
          '';
        links = {
        };
    ...
    "2652" = {
      settings = [
        { name = "browser.download.alwaysOpenPanel"; enabled = true; value = false; }
      ];
      meta = {
    ...
    "2654" = {
      settings = [
        { name = "browser.download.always_ask_before_handling_new_types"; enabled = true; value = true; }
      ];
      meta = {
  ...
  "2700" = {
    "2701" = {
      settings = [
        { name = "browser.contentblocking.category"; enabled = true; value = "strict"; }
      ];
      meta = {
    ...
    "2702" = {
      settings = [
        { name = "privacy.antitracking.enableWebcompat"; enabled = false; value = false; }
      ];
      meta = {
    ...
    "2710" = {
      settings = [
        { name = "privacy.partition.serviceWorkers"; enabled = true; value = true; }
      ];
      meta = {
    ...
    "2720" = {
      settings = [
        { name = "privacy.partition.always_partition_third_party_non_cookie_storage"; enabled = true; value = true; }
        { name = "privacy.partition.always_partition_third_party_non_cookie_storage.exempt_sessionstorage"; enabled = true; value = false; }
      ];
      meta = {
        title = "enable APS (Always Partitioning Storage)";
        description = ''
          '';
        links = {
        };
  ...
  "2800" = {
    ...
    "2811" = {
      settings = [
        ...
        { name = "privacy.clearOnShutdown.siteSettings"; enabled = false; value = false; }
      ];
      meta = {
    ...
    "2820" = {
      settings = [
        ...
        { name = "privacy.cpd.offlineApps"; enabled = true; value = false; }
        { name = "privacy.cpd.cookies"; enabled = true; value = false; }
        { name = "privacy.cpd.downloads"; enabled = false; value = true; }
        { name = "privacy.cpd.openWindows"; enabled = false; value = false; }
        { name = "privacy.cpd.passwords"; enabled = false; value = false; }
        { name = "privacy.cpd.siteSettings"; enabled = false; value = false; }
      ];
      meta = {
  ...
  "4500" = {
    "4501" = {
      settings = [
        ...
        { name = "privacy.resistFingerprinting.pbmode"; enabled = false; value = true; }
      ];
      meta = {
    ...
    "4502" = {
      settings = [
        { name = "privacy.window.maxInnerWidth"; enabled = true; value = 1600; }
        { name = "privacy.window.maxInnerHeight"; enabled = true; value = 900; }
      ];
      meta = {
    ...
    "4506" = {
      settings = [
        { name = "layout.css.font-visibility.resistFingerprinting"; enabled = false; value = 1; }
      ];
      meta = {
  ...
  "5000" = {
    ...
    "5017" = {
      settings = [
        { name = "extensions.formautofill.addresses.enabled"; enabled = false; value = false; }
        { name = "extensions.formautofill.creditCards.enabled"; enabled = false; value = false; }
      ];
      meta = {
    ...
    "5018" = {
      settings = [
        { name = "dom.popup_allowed_events"; enabled = false; value = "click dblclick mousedown pointerdown"; }
      ];
      meta = {
        title = "limit events that can cause a pop-up";
        description = ''
          '';
        links = {
        };
    ...
    "5019" = {
      settings = [
        { name = "browser.pagethumbnails.capturing_disabled"; enabled = false; value = true; }
      ];
      meta = {
    ...
    "5020" = {
      settings = [
        { name = "alerts.useSystemBackend.windows.notificationserver.enabled"; enabled = false; value = false; }
      ];
      meta = {
        title = "disable Windows native notifications and use app notications instead [FF111+] [WINDOWS]";
        description = ''
          '';
        links = {
        };
  ...
  "5500" = {
    ...
    "5507" = {
      settings = [
        { name = "gfx.font_rendering.opentype_svg.enabled"; enabled = false; value = false; }
      ];
      meta = {
  ...
  "6000" = {
    ...
    "6008" = {
      settings = [
        { name = "privacy.firstparty.isolate"; enabled = true; value = false; }
      ];
      meta = {
    ...
    "6009" = {
      settings = [
        { name = "extensions.webcompat.enable_shims"; enabled = true; value = true; }
      ];
      meta = {
    ...
    "6010" = {
      ...
      meta = {
        title = "enforce no TLS 1.0/1.1 downgrades";
        description = ''
          '';
    ...
    "6012" = {
      settings = [
        { name = "extensions.quarantinedDomains.enabled"; enabled = true; value = true; }
      ];
      meta = {
        title = "enforce Quarantined Domains [FF115+]";
        description = ''
          '';
    ...
    "6050" = {
      settings = [
        { name = "beacon.enabled"; enabled = false; value = ""; }
        { name = "browser.startup.blankWindow"; enabled = false; value = ""; }
        { name = "browser.newtab.preload"; enabled = false; value = ""; }
        { name = "browser.newtabpage.activity-stream.feeds.discoverystreamfeed"; enabled = false; value = ""; }
        { name = "browser.newtabpage.activity-stream.feeds.snippets"; enabled = false; value = ""; }
        { name = "browser.region.network.url"; enabled = false; value = ""; }
        { name = "browser.region.update.enabled"; enabled = false; value = ""; }
        { name = "browser.ssl_override_behavior"; enabled = false; value = ""; }
        { name = "devtools.chrome.enabled"; enabled = false; value = ""; }
        { name = "dom.disable_beforeunload"; enabled = false; value = ""; }
        { name = "dom.disable_open_during_load"; enabled = false; value = ""; }
        { name = "extensions.formautofill.available"; enabled = false; value = ""; }
        { name = "extensions.formautofill.addresses.supported"; enabled = false; value = ""; }
        { name = "extensions.formautofill.creditCards.available"; enabled = false; value = ""; }
        { name = "extensions.formautofill.creditCards.supported"; enabled = false; value = ""; }
        { name = "middlemouse.contentLoadURL"; enabled = false; value = ""; }
      ];
      meta = {
        title = "prefsCleaner: reset previously active items removed from arkenfox FF102+";
        description = ''
          '';
        links = {
        };
  ...
  "7000" = {
    ...
    "7006" = {
      settings = [
        { name = "dom.securecontext.allowlist_onions"; enabled = false; value = true; }
    ...
    "7014" = {
      settings = [
        { name = "extensions.systemAddon.update.enabled"; enabled = false; value = false; }
        { name = "extensions.systemAddon.update.url"; enabled = false; value = ""; }
      ];
      meta = {
    ...
    "7016" = {
      settings = [
        { name = "network.cookie.cookieBehavior"; enabled = false; value = 5; }
        { name = "network.http.referer.disallowCrossSiteRelaxingDefault"; enabled = false; value = true; }
        { name = "network.http.referer.disallowCrossSiteRelaxingDefault.top_navigation"; enabled = false; value = true; }
        { name = "privacy.partition.network_state.ocsp_cache"; enabled = false; value = true; }
        { name = "privacy.query_stripping.enabled"; enabled = false; value = true; }
        { name = "privacy.trackingprotection.enabled"; enabled = false; value = true; }
        { name = "privacy.trackingprotection.socialtracking.enabled"; enabled = false; value = true; }
    ...
    "7017" = {
      settings = [
        { name = "dom.serviceWorkers.enabled"; enabled = false; value = false; }
      ];
      meta = {
    ...
    "7019" = {
      settings = [
        { name = "dom.push.enabled"; enabled = false; value = false; }
      ];
      meta = {
    ...
    "7020" = {
      settings = [
        { name = "media.peerconnection.enabled"; enabled = false; value = false; }
      ];
      meta = {
  ...
  "8000" = {
    "8001" = {
      settings = [
        { name = "browser.display.use_document_fonts"; enabled = false; value = ""; }
        { name = "browser.zoom.siteSpecific"; enabled = false; value = ""; }
        { name = "device.sensors.enabled"; enabled = false; value = ""; }
        { name = "dom.enable_performance"; enabled = false; value = ""; }
        { name = "dom.enable_resource_timing"; enabled = false; value = ""; }
        { name = "dom.gamepad.enabled"; enabled = false; value = ""; }
        { name = "dom.maxHardwareConcurrency"; enabled = false; value = ""; }
        { name = "dom.w3c_touch_events.enabled"; enabled = false; value = ""; }
        { name = "dom.webaudio.enabled"; enabled = false; value = ""; }
        ...
        { name = "media.navigator.enabled"; enabled = false; value = ""; }
        { name = "media.ondevicechange.enabled"; enabled = false; value = ""; }
        { name = "media.video_stats.enabled"; enabled = false; value = ""; }
        { name = "media.webspeech.synth.enabled"; enabled = false; value = ""; }
        { name = "ui.use_standins_for_native_colors"; enabled = false; value = ""; }
        { name = "webgl.enable-debug-renderer-info"; enabled = false; value = ""; }
      ];
      meta = {
        title = "prefsCleaner: reset items useless for anti-fingerprinting";
        description = ''
          '';
        links = {
        };
  ...
  "9000" = {
    ...
    "9002" = {
      ...
      meta = {
        title = "disable General>Browsing>Recommend extensions/features as you browse [FF67+]";
        description = ''
          '';
        links = {
        };
    ...
    "9003" = {
      ...
      meta = {
        title = "disable What's New toolbar icon [FF69+]";
        description = ''
          '';
        links = {
        };
    ...
    "9004" = {
      settings = [
        { name = "browser.urlbar.showSearchTerms.enabled"; enabled = true; value = false; }
      ];
      meta = {
        title = "disable search terms [FF110+]";
        description = ''
          '';
