{
  ...
  "0800" = {
    ...
    "0807" = {
      settings = [
        { name = "browser.urlbar.suggest.quicksuggest"; enabled = true; value = false; }
  ...
  "2000" = {
    ...
    "2002" = {
      ...
      meta = {
        title = "limit WebRTC private network address leaks";
        description = ''
  ...
  "9000" = {
    "9000" = {
      settings = [
        ...
        { name = "browser.tabs.warnOnQuitShortcut"; enabled = false; value = false; }
