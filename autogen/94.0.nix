{
  ...
  "6000" = {
    ...
    "6050" = {
      settings = [
        {
          name = "browser.newtabpage.activity-stream.asrouter.providers.snippets";
          enabled = false;
          value = "";
        }
        {
        ...
        {
          name = "media.getusermedia.audiocapture.enabled";
          enabled = false;
          value = "";
        }
        {
        ...
        {
          name = "media.gmp-widevinecdm.visible";
          enabled = false;
          value = "";
        }
        {
          name = "network.http.redirection-limit";
          enabled = false;
          value = "";
        }
        {
        ...
        {
          name = "security.insecure_connection_icon.enabled";
          enabled = false;
          value = "";
        }
        {
  ...
  "7000" = {
    ...
    "7009" = {
      settings = [
        ...
        {
          name = "network.http.spdy.enabled.deps";
          enabled = false;
          value = false;
        }
        {
          name = "network.http.spdy.enabled.http2";
          enabled = false;
          value = false;
        }
        {
          name = "network.http.spdy.websockets";
          enabled = false;
          value = false;
        }
      ];
  ...
  "9000" = {
    "9000" = {
      settings = [
        ...
        {
          name = "browser.tabs.warnOnQuitShortcut";
          enabled = false;
          value = false;
        }
        {
